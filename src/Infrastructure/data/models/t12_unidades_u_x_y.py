...
class AMateria( Base ):
    ...
    Lytic_Ground_Stone = Column( 'Lytic_Ground_Stone', String(30), nullable=False )
...
class Stratigraphy( Base ):
    ...
    Lots_below = Column( String(20), nullable=False ) 
    Lots_next_to = Column( String(20), nullable=False ) 
